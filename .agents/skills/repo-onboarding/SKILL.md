...
## When to use
- Start of a new Codex session on this repo
...
**Docs:** `AGENTS.md` (rules) · `docs/decisions.md` (all arch decisions D001–D015+) · `tasks/todo.md` (active checklist) · `tasks/lessons.md` (lessons log)
...
```
1. Codex: write spec / acceptance criteria → /specs/ or /tasks/todo.md
2. Codex: convert to 5–20 checklist items in /tasks/todo.md
3. Codex:  implement next 1–3 unchecked items; run pnpm lint && pnpm typecheck && pnpm test
4. Codex: review diff, smoke check, create Fix List if needed
5. Codex:  apply Fix List; Codex verifies; Codex commits/pushes
```
