...
description: >
  ...
  in /tasks/todo.md. Each item has an owner (Codex/Codex), target files,
...
- **[Codex]** — architecture decisions, RLS verification, security review, commit/push
...
- Never include tasks that persist raw chat text (AGENTS.md Hard Rule #1)
